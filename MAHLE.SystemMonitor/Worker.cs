    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                var interval = _configuration.GetValue<int>("MonitoringSettings:CheckIntervalSeconds");
                _logger.LogInformation("Monitoring cycle completed. Next check in {interval} seconds", interval);
